...
public class VolleyApplication extends Application {
    //クラスはこのようにintのような型として使えます。Activityクラスだと消えれば消える。Applicationクラスはアプリ起動中生き続ける。volleyは通信系なのでずっと使いたいからこれ。
    private static VolleyApplication sInstance;

    private RequestQueue mRequestQueue;
    //overrideは継承元のクラスApplicationの機能を引き継ぐのではなく上書きすることを宣言しています。
    //onCreateはアプリを起動した時にOSから呼び出される関数です。よく使います。起動時に一回だけ実行される。
    @Override
